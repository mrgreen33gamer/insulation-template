  ...
  return (
    ...
    >
      ...
      <nav aria-label="Services navigation" style={{
        ...
        <Link href="/services">All Services — ThermoShield Insulation</Link>
      </nav>

      <span id={styles.backgroundImage}>
        <Image quality={100} fill style={{ objectFit: 'cover' }} sizes="100vw" src='/pages/home/services/background-image.png?v=3' alt="Background Image for Services Page - ThermoShield Insulation - Background" />
      </span>
    ...
    >
      ...
      >
        <Image
          ...
          src={imgSrc}
          quality={100}
          alt={`${imgAlt} - ThermoShield Insulation LLC - Waco TX`}
        />
      </motion.div>
    </motion.div>
  );
