...
const SERVICES = [
  { icon: faWrench,          label: 'Attic Insulation' },
  { icon: faLink,            label: 'Spray Foam' },
  { icon: faDoorOpen,        label: 'Blown-In Cellulose' },
  { icon: faCogs,            label: 'Wall Insulation' },
  { icon: faClipboardList,   label: 'Air Sealing' },
  { icon: faBuilding,        label: 'Energy Audits' },
  { icon: faBolt,            label: 'Urgent Assessment' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'BPI · Insured' },
  { icon: faStar,         text: '4.9★ · 600+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed ThermoShield Insulation technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548505050"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 850-5050', section: 'ContactForm-V1' })}>
                          Call (254) 850-5050
                        </a>
                      </span>
                    </div>
