...
const SERVICES = [
  { icon: faWrench,        label: 'Attic Insulation',  sub: 'Top-ups & full attic installs' },
  { icon: faLink,          label: 'Spray Foam',      sub: 'Open- or closed-cell systems' },
  { icon: faDoorOpen,      label: 'Blown-In Cellulose',    sub: 'Even attic coverage' },
  { icon: faCogs,          label: 'Wall Insulation',      sub: 'Dense-pack exterior walls' },
  { icon: faClipboardList, label: 'Air Sealing',    sub: 'Penetrations, can lights, ducts' },
  { icon: faBuilding,      label: 'Energy Audits',    sub: 'Prioritized comfort upgrades' },
  { icon: faBolt,          label: 'Urgent Assessment',           sub: 'Hot rooms, high bills — call today' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed ThermoShield Insulation tech will reach out about your <strong>{selectedService}</strong> service.
                  </p>
