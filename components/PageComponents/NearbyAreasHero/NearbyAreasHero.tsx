...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Insulation Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `ThermoShield Insulation provides fast, reliable insulation service to ${cityName} and all surrounding communities. BPI-aligned installers, flat-rate pricing, 5-year workmanship warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12548505050" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
