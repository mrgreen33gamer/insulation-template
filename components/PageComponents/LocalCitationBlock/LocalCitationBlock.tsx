...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'ThermoShield Insulation',
  address       = 'Waco, TX 76706',
  phone         = '(254) 850-5050',
  email         = 'service@thermoshieldinsulation.com',
  googleMapsUrl = 'https://maps.google.com/?q=ThermoShield+Insulation+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed insulation specialists.
          </p>
        </div>
