...
export default function CTABanner({
  headline      = "Ready for a Cooler, More Efficient Home?",
  subline   = "Same-day appointments available. Flat-rate pricing â€” no hidden fees. Call now or grab a free estimate online.",
      ...
      <div className={styles.inner}>
        ...
        >
          <span className={styles.eyebrow}>
            ...
            Central Texas Insulation Experts Since 2012
          </span>
