...
export default function CTABanner({
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "ThermoShield · Central Texas",
  badgeA = "Blown-In",
  badgeB = "Air Seal",
  badgeC = "R-Value",
}: CTABannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <svg width="400" height="400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2"><path d="M12 2v20M4.9 6.5l14.2 11M4.9 17.5l14.2-11"/></svg>
      </motion.div>
