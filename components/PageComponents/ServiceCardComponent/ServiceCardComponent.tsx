...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Insulation Needs',
  subheading = 'From attic top-ups to spray foam and air sealing, ThermoShield Insulation handles it all — on time, on price.',
