...
// ThermoShield Insulation — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full attic insulation, spray foam, cellulose, wall insulation, air sealing, and energy audits across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full insulation coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Insulation upgrades'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Comfort & Efficiency Guarantee · 5-Year Workmanship as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Comfort & Efficiency Guarantee · 5-Year Workmanship', 'BPI-aligned'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable insulation service for Bellmead residents and businesses. Insulation upgrades, repairs, and air sealing installs — same-day when available.',
    highlights:  ['Residential & commercial', 'BPI-aligned installers', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential insulation service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Insulation repair, spray foam, and light commercial work for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'Insulation upgrades', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Insulation repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service insulation coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial insulation.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial insulation in all areas?',
    answer: 'Yes — light commercial insulation for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Insulation — Since 2012
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, BPI-aligned installers, and a Comfort & Efficiency Guarantee · 5-Year Workmanship — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12548505050" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common insulation issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12548505050" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12548505050" className={styles.unlistedCTA}>
            Call (254) 850-5050
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Comfort & Efficiency Guarantee · 5-Year Workmanship, no contracts ever."
