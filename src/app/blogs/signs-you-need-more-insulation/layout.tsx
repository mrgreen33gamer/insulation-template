...
const slug = 'signs-you-need-more-insulation';
...
export const metadata: Metadata = {
  ...
  keywords: ['signs need more insulation', 'hot upstairs rooms Waco', 'attic insulation needed Texas', 'energy bills insulation'],
