    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>ThermoShield Insulation — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Practical insulation safety tips, spray foam guidance, and air sealing advice for Central Texas homeowners.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a licensed insulation technician in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been insulating Waco-area homes and businesses with expert insulation repair, spray foam, and installations since 2011. Free estimate, no obligations.
            </p>
