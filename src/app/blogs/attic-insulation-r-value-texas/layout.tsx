...
const slug = 'attic-insulation-r-value-texas';
...
export const metadata: Metadata = {
  ...
  keywords: ['attic insulation R-value Texas', 'attic insulation Waco TX', 'R-38 attic Texas', 'insulation top-up Central Texas'],
